...
[![Tests](https://github.com/arithefirst/svchat/actions/workflows/playwright.yml/badge.svg)](https://github.com/arithefirst/svchat/actions/workflows/playwright.yml)

## 💻 Techstack

![Techstack](https://go-skill-icons.vercel.app/api/icons?i=cassandra,docker,playwright,socketio,sqlite,svelte,tailwindcss,ts)
